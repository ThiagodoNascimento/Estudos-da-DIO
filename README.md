O código fornecido é um programa simples de simulação de operações bancárias. Ele permite ao usuário realizar três tipos de operações: depósito, saque e visualização do extrato da conta.
